<div class="normosa-ui-datatable" id="datatable">
    ...
    <div class="scrollpane">
        <div class=content style="min-width:1000px;">
            <div class="th">
                <span class="td w300" style="text-align:center">Email</span>
            ...
            for ($i = 0; $i < $subscribers->count(); $i++) {
                ...
                ?>
                <div class="tr" <?php echo $style ?> id="<?php echo $subscribers[$i]->getValue('id') ?>">
                    <div class="content">
                        <span class="td w300"><?php echo strtolower($subscribers[$i]->getValue('email')) ?></span>
